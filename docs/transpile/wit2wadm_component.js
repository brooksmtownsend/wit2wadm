...
const $init = (async() => {
  const module0 = fetchCompile(new URL('./wit2wadm_component.core.wasm', import.meta.url));
  const module1 = fetchCompile(new URL('./wit2wadm_component.core2.wasm', import.meta.url));
  const module2 = base64Compile('');
  const module3 = base64Compile('');
  ...
  postReturn0 = exports1['cabi_post_wasmcloud:tools/convert#component-to-wadm'];
})();

await $init;
const convert = {
  componentToWadm: componentToWadm,
  
};

export { convert, convert as 'wasmcloud:tools/convert',  }